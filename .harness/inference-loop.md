...
2. **Scope**
   - Allowed roots: `plugins/bounded-runtime-harness/`, `.agents/plugins/`, `.harness/`, `.governance/`, `scripts/`, `hooks/`, and root identity files (`README.md`, `AGENTS.md`, `CLAUDE.md`, `CONTEXT.md`, `LICENSE`, `.gitignore`).
